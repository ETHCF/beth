...
contract BETHBytecodeHash is Test {
    ...
    bytes32 internal constant EXPECTED_RUNTIME_CODE_HASH = hex"ec7b43423f3613d30d52451076f64b966f928c550edd267dcaa377d804fa7f9e";
    ...
    function test_RuntimeCodeHash_MatchesExpected() public {
        ...
        assertEq(codehash, EXPECTED_RUNTIME_CODE_HASH, "Runtime code hash mismatch; run make update-golden");
    }
}
